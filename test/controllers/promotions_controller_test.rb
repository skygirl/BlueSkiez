...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { Description: @promotion.Description, EndDate: @promotion.EndDate, ImagePath: @promotion.ImagePath, StartDate: @promotion.StartDate, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { Description: @promotion.Description, EndDate: @promotion.EndDate, ImagePath: @promotion.ImagePath, StartDate: @promotion.StartDate, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
